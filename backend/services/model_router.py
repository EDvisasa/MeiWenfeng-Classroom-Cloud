...
from backend.services.agent_executor import LLMClientProtocol, AgentExecutor, OpenAILLMClient
...
def stream_chat(
    ...
    formatted_messages = assemble_messages(messages, system_prompt)
